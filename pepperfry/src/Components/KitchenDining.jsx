export default function KitchenDining(){
    ...
    return (
        <div>
            <div>
            <img style={{width:"90%",marginTop:"10px"}} src="https://ii3.pepperfry.com/assets/6c024d_1676542865470_kitchen%26dining_1280_promobanner_16feb.jpg" alt="err"/>
            </div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Explore the Latest Trends</h2>
            </div>
