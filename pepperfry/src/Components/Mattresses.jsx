export default function Mattresses(){
    ...
    return(
        <div>
            <div>
            <img style={{width:"90%",marginTop:"10px"}} src="https://ii2.pepperfry.com/assets/2256f737-566f-4a88-bea0-47bd93a24715.jpg" alt="err"/>
            </div>
            <div style={{fontFamily:"Manrope, sans-serif"}}>
            <h2 style={{color:"#a57137"}}>Shop By Categories</h2>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:"10px",width:"90%",margin:"auto",fontFamily:"Manrope, sans-serif",fontWeight:"400px"}}>
                {data1.map((ele)=>(
                    <div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Select Mattress by Type</h2>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"10px",width:"90%",margin:"auto",fontFamily:"Manrope, sans-serif",fontWeight:"400px"}}>
                {data4.map((ele)=>(
                    <div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Select Mattress by Comfort Level</h2>
            </div>
