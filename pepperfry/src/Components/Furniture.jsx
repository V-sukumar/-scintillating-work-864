function Furniture(){
   ...
   let data2=[
    ...
    return (
        <div>
            <div>
            <img style={{width:"90%",marginTop:"10px"}} src="https://ii3.pepperfry.com/assets/77764c_1676462366378_Furniture_1280_promobanner_15feb_1.jpg" alt="err" />
            </div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Care For Your Furniture</h2>
            </div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Follow Trends In Furniture</h2>
            </div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}}>
                 <h2 style={{color:"#a57137"}}>Check Out These Curated Collections</h2>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"10px",width:"90%",margin:"auto",fontFamily:"Manrope, sans-serif",fontWeight:"400px"}}>
                {data6.map((ele)=>(
                    <div>
