...
let data6=[
  ...
  return (
    <div>
       <Navbar />
       <div>
            <img style={{width:"90%",marginTop:"20px",margin:"auto"}} src="https://ii1.pepperfry.com/assets/a831d4_1676546293481_Appliances_banner_16feb_1280.jpg" alt="err"/>
            </div>
            ...
            <div style={{fontFamily:"Manrope, sans-serif"}} >
            <Link to="/AppliancesProducts" style={{color:"#ff7035"}} >Show all Products</Link>
            </div>
            <div style={{fontFamily:"Manrope, sans-serif"}}>
            ...
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>Appliances come in various products like mixers and processors, OTGs, food makers, chimneys, cooktops & Breakfast appliances with sizes and colors, so it is important to select one that matches your kitchen. You may want to look for an appliance that is built to last, or one that is made of a material such as stainless steel. You may also want to consider a warranty since appliances can wear out over time.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>There are many different kitchen appliances, from small appliances to large appliances. There are even appliances that do everything from cooking to cleaning, and even cooling your food. In addition, kitchen appliances are usually hidden behind a panel that matches your kitchen's style.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>You can get appliances that are made of all sorts of materials. Some of the more popular materials are stainless steel and porcelain. You may want to consider a countertop oven or a cooktop that is integrated into your oven.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>These items can be found in most homes, are essential for cooking, and baking. They can also come with a variety of features and benefits and can help you prepare food more efficiently and safely. They are also one of the most expensive kitchen items you can buy, so be sure to budget appropriately.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>Using the latest in technology, kitchen appliances can do a lot of things for you. Most kitchen appliances can be integrated into your kitchen, or even your furniture. You can also get appliances that are self-contained, so you do not have to worry about finding space for them.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>In addition to the major kitchen appliances, you can find minor appliances, such as blenders and juice extractors. The best part about them is that they can save you a lot of time and energy and can be an integral part of your kitchen design.</p>
            <p style={{textAlign:"justify",marginLeft:"50px",fontSize:"14px",marginRight:'50px'}}>The most important thing to remember when selecting a appliance is to measure the space available. This will help you to find the right model. Also, be sure to read the fine print before buying, as some appliances come with limited warranties, which can end up costing you a lot of money overall.</p>
            <p style={{textAlign:"left",marginLeft:'50px',fontSize:"14px"}}><b>Why should you buy appliances products from Pepperfry?</b></p>
